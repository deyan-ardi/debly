...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		if (!$this->ion_auth->logged_in()) {
			...
			$this->data['title'] = "Deb.ly - Dashboard Pengguna | Persingkat Tautan & Kustomisasi Tautan ";
			$this->data['id'] = 1;
			$this->data['nav'] = 1;
			// Bagian Notifikasi
			$this->data['ditambahkan'] = $this->All_model->getNotifDitambahkan($_SESSION['user_id']);
			$this->data['dihapus'] = $this->All_model->getNotifDihapus($_SESSION['user_id']);
			$this->data['bergabung'] = $this->All_model->getNotifBergabung();
			$this->data['tautan'] = $this->All_model->getTotalTautan();
			// Bagian Diagram
			$this->data['aktif'] = $this->All_model->getAktifTautan($_SESSION['user_id']);
			$this->data['non_aktif'] = $this->All_model->getNonAktifTautan($_SESSION['user_id']);
	...
	public function login()
	{
		if ($this->ion_auth->logged_in()) {
			...
			if ($this->form_validation->run() === TRUE) {
				...
				$this->data['title'] = "Deb.ly - Mendaftar | Persingkat Tautan & Kustomisasi Tautan ";
				$this->data['id'] = 0;
	...
	public function create_user()
	{
		if ($this->ion_auth->logged_in()) {
			...
			// validate form input
			$this->form_validation->set_rules('first_name', $this->lang->line('create_user_validation_fname_label'), 'trim|required|min_length[6]');
			...
			if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
				...
				$this->data['first_name'] = [
					...
					'placeholder' => "Panjang minimal 6 karakter",
					'required' => true,
				];
				// $this->data['last_name'] = [
				// 	'name' => 'last_name',
