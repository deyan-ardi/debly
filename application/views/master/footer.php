...
<footer id="footer_section" class="footer_section bg_gray_2 deco_wrap sec_ptb_120 pb-0 clearfix">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="copyright_text">
                        <p class="mb-0">
                            Copyright &copy; <?= date('Y') ?>. Develop by <a href="" class="author_link">Ganatech</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="social_icon ul_li_center">
                        <ul class="clearfix">
                            <li>
                                <img src="<?= base_url() ?>assets/images/logo/debly.png" alt="spahe_not_found">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="footer_menu ul_li_right">
                        <ul class="clearfix">
                            <li><a href="#" data-toggle="modal" data-target="#ketentuanLayanan">Ketentuan
                                    Layanan</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#kebijakanPrivasi">Kebijakan
                                    Privasi</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="deco_image cloud_image cloud_1">
        <img src="<?= base_url() ?>assets/images/shapes/shape_55.png" alt="spahe_not_found" data-aos="fade-up"
            data-aos-delay="100">
    </div>
    <div class="deco_image cloud_image cloud_2">
        <img src="<?= base_url() ?>assets/images/shapes/shape_55.png" width="65" alt="spahe_not_found"
            data-aos="fade-up" data-aos-delay="300">
    </div>
    <div class="deco_image cloud_image cloud_3">
        <img src="<?= base_url() ?>assets/images/shapes/shape_55.png" alt="spahe_not_found" data-aos="fade-up"
            data-aos-delay="200">
    </div>
...
<div class="modal fade" id="ketentuanLayanan" tabindex="-1" aria-labelledby="ketentuanLayananLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ketentuanLayananLabel">Terms and Conditions</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body text-justify">
                <p>Welcome to Deb.ly!</p>

                <p>These terms and conditions outline the rules and regulations for the use of Deb.ly's Website, located
                    at https://debly.cc.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Deb.ly if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    therefore as referring to same. Our Terms and Conditions were created with the help of the <a
                        href="https://www.privacypolicyonline.com/terms-conditions-generator/">Terms & Conditions
                        Generator</a> and the <a href="https://www.generateprivacypolicy.com">Privacy Policy
                        Generator</a>.</p>

                <h3><strong>Cookies</strong></h3>

                <p>We employ the use of cookies. By accessing Deb.ly, you agreed to use cookies in agreement with the
                    Deb.ly's Privacy Policy.</p>
                ...
                <p>Unless otherwise stated, Deb.ly and/or its licensors own the intellectual property rights for all
                    material on Deb.ly. All intellectual property rights are reserved. You may access this from Deb.ly
                    for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Deb.ly</li>
                    <li>Sell, rent or sub-license material from Deb.ly</li>
                    <li>Reproduce, duplicate or copy material from Deb.ly</li>
                    <li>Redistribute content from Deb.ly</li>
                </ul>

                <p>This Agreement shall begin on the date hereof.</p>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Deb.ly does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of Deb.ly,its agents
                    and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Deb.ly shall not be liable for the Comments or
                ...
                <p>Deb.ly reserves the right to monitor all Comments and to remove any Comments which can be considered
                ...
                <p>You hereby grant Deb.ly a non-exclusive license to use, reproduce, edit and authorize others to use,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of Deb.ly; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Deb.ly. Please include your name, your
                ...
                <p>No use of Deb.ly's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
...
<!-- End Modal Ketentuan Layanan -->
<!-- Modal Kebijakan Privasi -->
<div class="modal fade" id="kebijakanPrivasi" tabindex="-1" aria-labelledby="kebijakanPrivasiLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kebijakanPrivasiLabel">Privacy Policy</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body text-justify">
                <p>At Deb.ly, accessible from https://debly.cc, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by Deb.ly and how we use it.</p>
                ...
                <p>Deb.ly follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, Deb.ly uses 'cookies'. These cookies are used to store information including
                ...
                <p>For more general information on cookies, please read the "What Are Cookies" article on <a
                        href="https://www.cookieconsent.com/what-are-cookies/">Cookie Consent website</a>.</p>



                <h2>Privacy Policies</h2>

                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Deb.ly.
                </p>

                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Deb.ly, which are sent directly
                ...
                <p>Note that Deb.ly has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>Deb.ly's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                ...
                <p>Deb.ly does not knowingly collect any Personal Identifiable Information from children under the age
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Deb.ly. This policy is not
...
<script src="<?= base_url() ?>assets/js/splitting.js"></script>
