...
function copy_text_1() {
    $("#tautan_0").select();
    if (document.execCommand("copy")) {
    $('#btn_1').text("Berhasil Disalin");
    $("#btn_1").removeClass("bg_default_blue");
    $("#btn_1").addClass("bg_default_orange");
    setTimeout(function () {
      $('#btn_1').text("Salin Tautan Baru");
       $("#btn_1").removeClass("bg_default_orange");
    $("#btn_1").addClass("bg_default_blue");
    }, 2500)
  }
}
function copy_text_2() {
    $("#tautan_1").select();
    if (document.execCommand("copy")) {
    $('#btn_2').text("Berhasil Disalin");
    $("#btn_2").removeClass("bg_default_blue");
    $("#btn_2").addClass("bg_default_orange");
    setTimeout(function () {
      $('#btn_2').text("Salin Tautan Baru");
       $("#btn_2").removeClass("bg_default_orange");
    $("#btn_2").addClass("bg_default_blue");
    }, 2500)
  }
}
function copy_text_3() {
  $("#tautan_2").select();
  if (document.execCommand("copy")) {
    $('#btn_3').text("Berhasil Disalin");
    $("#btn_3").removeClass("bg_default_blue");
    $("#btn_3").addClass("bg_default_orange");
    setTimeout(function () {
      $('#btn_3').text("Salin Tautan Baru");
       $("#btn_3").removeClass("bg_default_orange");
    $("#btn_3").addClass("bg_default_blue");
    }, 2500)
  }
